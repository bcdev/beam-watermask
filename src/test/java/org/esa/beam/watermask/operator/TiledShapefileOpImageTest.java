...
public class TiledShapefileOpImageTest {
    ...
    public void testGetTileBasenames() throws Exception {
        ...
        assertEquals("e000n05", TiledShapefileOpImage.getTileBasename(180, 84));
        ...
        final Point point = new WatermaskClassifier(1024).computeTileIndex(new WatermaskClassifier.GeoPos(5.0f, 0.0f));
        final String basename = TiledShapefileOpImage.getTileBasename(point.x, point.y);
        assertEquals("e000n05", basename);
    }
